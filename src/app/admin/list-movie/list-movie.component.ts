...
export class ListMovieComponent implements OnInit, AfterViewInit, OnDestroy {
	...
	showReg(id: any): void {
		...
		this.apiConn.update('movies/enable', { id: id }).subscribe(
			(respuesta: any) => {
	...
	HiddeReg(id: any): void {
		this.noti.mensaje('', 'Guardando su solicitud.', 'info');
		this.apiConn.update('movies/disable', { id: id }).subscribe(
			(respuesta: any) => {
